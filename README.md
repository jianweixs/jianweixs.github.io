...
# SNS settings
github_username: jianweixs     # 你的github账号
...
看右边:
![](https://raw.githubusercontent.com/jianweixs/jianweixs.github.io/master/img/readme-side.png)
...
friends: [
    {
        title: "BY Blog",
        href: "https://jianweixs.github.io/"
    },
    {
        title: "Apple",
...
2. 以上教程来自[BY](https://github.com/qiubaiying/qiubaiying.github.io)
2. 感谢 Jekyll、Github Pages 和 Bootstrap!

## License

遵循 MIT 许可证。有关详细,请参阅 [LICENSE](https://github.com/jianweixs/jianweixs.github.io/blob/master/LICENSE)。
